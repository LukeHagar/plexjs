 ...
 */
export function dvRsGetDVRGuide(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDVRGuideRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/dvrs/{dvrId}/guide")(pathParams);
