...
import { ShareServerLegacyServerList } from "../models/operations/shareserverlegacy.js";
 ...
 */
export function usersShareServerLegacy(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ShareServerLegacyRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ShareServerLegacyServerList[0], {
  ...
  const path = pathToFunc("/servers/{machineId}/shared_servers")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.SuccessResponse$inboundSchema),
