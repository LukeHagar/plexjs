...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUpdateStatusResponse$inboundSchema, {
      key: "object",
    }),
    M.jsonErr(400, errors.GetUpdateStatusBadRequest$inboundSchema),
    M.jsonErr(401, errors.GetUpdateStatusUnauthorized$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
