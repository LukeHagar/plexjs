 ...
 */
export function hubsGetContinueWatchingItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetContinueWatchingItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/continueWatching/items")();
  ...
  const context = {
    ...
    operationID: "getContinueWatchingItems",
    oAuth2Scopes: null,
