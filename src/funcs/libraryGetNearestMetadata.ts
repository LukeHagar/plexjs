 ...
 */
export function libraryGetNearestMetadata(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetNearestMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/nearest")(pathParams);
