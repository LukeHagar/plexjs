...
import { AddUserWebhookServerList } from "../models/operations/adduserwebhook.js";
 ...
 */
export function generalAddUserWebhook(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddUserWebhookRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AddUserWebhookServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/api/v2/user/webhooks")();
