 ...
 */
export function playbackPlayerSetStreams(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerSetStreamsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/setStreams")();
