...
export async function serverGetMediaProviders(
    ...
    Result<
        models.GetMediaProvidersResponse,
        | models.GetMediaProvidersServerResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
    ...
    >
> {
    const input$: models.GetMediaProvidersRequest = {
        xPlexToken: xPlexToken,
    };

    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => models.GetMediaProvidersRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetMediaProvidersResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetMediaProvidersServerResponseBody$inboundSchema)
