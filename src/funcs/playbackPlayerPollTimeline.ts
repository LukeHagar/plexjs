 ...
 */
export function playbackPlayerPollTimeline(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerPollTimelineRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/timeline/poll")();
