 ...
 */
export function libraryGetByResolution(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetByResolutionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/byResolution")(
    pathParams,
  );
