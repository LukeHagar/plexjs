 ...
 */
export function libraryGetSectionTimeline(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSectionTimelineRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/timeline")(pathParams);
