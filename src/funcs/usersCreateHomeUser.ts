...
import { CreateHomeUserServerList } from "../models/operations/createhomeuser.js";
 ...
 */
export function usersCreateHomeUser(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateHomeUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateHomeUserServerList[0], { charEncoding: "percent" })();
