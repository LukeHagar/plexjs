...
import { DeleteHomeUserServerList } from "../models/operations/deletehomeuser.js";
 ...
 */
export function usersDeleteHomeUser(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteHomeUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteHomeUserServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/home/users/{userId}")(pathParams);
