 ...
 */
export function playbackPlayerSetParameters(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlayerSetParametersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/setParameters")();
