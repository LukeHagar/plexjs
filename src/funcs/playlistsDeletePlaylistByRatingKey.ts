 ...
 */
export function playlistsDeletePlaylistByRatingKey(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletePlaylistByRatingKeyRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deletePlaylistByRatingKey",
    oAuth2Scopes: null,
