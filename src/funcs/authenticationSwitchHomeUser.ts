...
import { SwitchHomeUserServerList } from "../models/operations/switchhomeuser.js";
 ...
 */
export function authenticationSwitchHomeUser(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SwitchHomeUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(SwitchHomeUserServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/home/users/{id}/switch")(pathParams);
