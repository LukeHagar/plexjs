 ...
 */
export function playbackPlayerVideoStream(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerVideoStreamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/videoStream")();
