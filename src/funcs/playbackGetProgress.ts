 ...
 */
export function playbackGetProgress(
  client: PlexAPICore,
  request: operations.GetProgressRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.ProgressResponse,
    | errors.ErrorT
    | PlexAPIError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetProgressRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.ProgressResponse$inboundSchema),
