 ...
 */
export function libraryOptimizeSectionPost(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.OptimizeSectionPostRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/optimize")(pathParams);
