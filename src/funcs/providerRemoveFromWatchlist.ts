...
import { RemoveFromWatchlistServerList } from "../models/operations/removefromwatchlist.js";
 ...
 */
export function providerRemoveFromWatchlist(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveFromWatchlistRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RemoveFromWatchlistServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/actions/removeFromWatchlist")();
