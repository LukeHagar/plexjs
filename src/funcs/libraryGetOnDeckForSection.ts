 ...
 */
export function libraryGetOnDeckForSection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOnDeckForSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/onDeck")(pathParams);
