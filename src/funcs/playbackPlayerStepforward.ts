 ...
 */
export function playbackPlayerStepforward(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerStepforwardRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/stepForward")();
