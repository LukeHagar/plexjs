 ...
 */
export function liveTVGetDVRRecordingsByDVR(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDVRRecordingsByDVRRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/dvrs/{dvrId}/recordings")(pathParams);
  ...
  const context = {
    ...
    operationID: "getDVRRecordingsByDVR",
    oAuth2Scopes: null,
