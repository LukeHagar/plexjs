...
import { AddToWatchlistServerList } from "../models/operations/addtowatchlist.js";
 ...
 */
export function providerAddToWatchlist(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddToWatchlistRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AddToWatchlistServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/actions/addToWatchlist")();
