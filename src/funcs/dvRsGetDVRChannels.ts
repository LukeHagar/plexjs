 ...
 */
export function dvRsGetDVRChannels(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDVRChannelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/dvrs/{dvrId}/channels")(pathParams);
