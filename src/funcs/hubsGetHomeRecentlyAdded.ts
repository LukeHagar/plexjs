 ...
 */
export function hubsGetHomeRecentlyAdded(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHomeRecentlyAddedRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/home/recentlyAdded")();
