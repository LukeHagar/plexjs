 ...
 */
export function libraryComputeSonicPath(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ComputeSonicPathRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/computePath")(pathParams);
