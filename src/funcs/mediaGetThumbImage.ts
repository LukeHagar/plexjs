...
export async function mediaGetThumbImage(
    ...
    Result<
        models.GetThumbImageResponse,
        | models.GetThumbImageResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => models.GetThumbImageRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.stream(200, models.GetThumbImageResponse$inboundSchema, {
            ctype: "image/jpeg",
            hdrs: true,
            key: "response-stream",
        }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetThumbImageResponseBody$inboundSchema)
