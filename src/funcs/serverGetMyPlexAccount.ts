...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetMyPlexAccountResponse$inboundSchema, {
      key: "object",
    }),
    M.jsonErr(400, errors.GetMyPlexAccountBadRequest$inboundSchema),
    M.jsonErr(401, errors.GetMyPlexAccountUnauthorized$inboundSchema),
    M.fail(["4XX", "5XX"]),
