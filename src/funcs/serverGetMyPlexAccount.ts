...
export async function serverGetMyPlexAccount(
    ...
    Result<
        models.GetMyPlexAccountResponse,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetMyPlexAccountResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetMyPlexAccountServerResponseBody$inboundSchema)
