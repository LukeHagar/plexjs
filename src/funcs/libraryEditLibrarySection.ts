 ...
 */
export function libraryEditLibrarySection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EditLibrarySectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/edit")(pathParams);
