...
export async function serverGetServerCapabilities(
    ...
    Result<
        models.GetServerCapabilitiesResponse,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetServerCapabilitiesResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetServerCapabilitiesServerResponseBody$inboundSchema)
