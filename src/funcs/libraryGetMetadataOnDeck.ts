 ...
 */
export function libraryGetMetadataOnDeck(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMetadataOnDeckRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/onDeck")(pathParams);
