 ...
 */
export function libraryGetMetadataParent(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMetadataParentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/parent")(pathParams);
