...
export async function serverGetServerPreferences(
    ...
    Result<
        ...
        | errors.GetServerPreferencesServerResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    >(
        ...
        m$.jsonErr(400, errors.GetServerPreferencesResponseBody$inboundSchema),
        m$.jsonErr(401, errors.GetServerPreferencesServerResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
