 ...
 */
export function libraryGetSectionPlaylists(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSectionPlaylistsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/playlists")(
    pathParams,
  );
