...
import { GetAuthNonceServerList } from "../models/operations/getauthnonce.js";
 ...
 */
export function authenticationGetAuthNonce(
  client: PlexAPICore,
  request: operations.GetAuthNonceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.AuthNonceResponse,
    | errors.ErrorT
    | PlexAPIError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAuthNonceRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAuthNonceServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.AuthNonceResponse$inboundSchema),
