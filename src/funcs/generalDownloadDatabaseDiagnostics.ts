 ...
 */
export function generalDownloadDatabaseDiagnostics(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DownloadDatabaseDiagnosticsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/diagnostics/databases")();
