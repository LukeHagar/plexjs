 ...
 */
export function transcoderGetDASHSegment(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDASHSegmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/{transcodeType}/:/transcode/universal/session/{sessionId}/{segmentId}.m4s",
  )(pathParams);
