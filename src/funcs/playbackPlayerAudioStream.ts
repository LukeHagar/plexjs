 ...
 */
export function playbackPlayerAudioStream(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerAudioStreamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/audioStream")();
