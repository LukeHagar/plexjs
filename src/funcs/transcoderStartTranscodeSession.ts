...
export enum StartTranscodeSessionAcceptEnum {
...
> {
  ...
  const headers = new Headers(compactMap({
    Accept: options?.acceptHeaderOverride
      || "application/vnd.apple.mpegurl;q=1, text/html;q=0.7, video/x-matroska;q=0",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.StartTranscodeSessionResponse$inboundSchema, {
