...
export async function libraryGetRecentlyAdded(
  ...
  Result<
    ...
    | errors.GetRecentlyAddedBadRequest
    | errors.GetRecentlyAddedUnauthorized
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    m$.jsonErr(400, errors.GetRecentlyAddedBadRequest$inboundSchema),
    m$.jsonErr(401, errors.GetRecentlyAddedUnauthorized$inboundSchema),
    m$.fail(["4XX", "5XX"]),
