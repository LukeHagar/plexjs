 ...
 */
export function libraryUnmatchSectionItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnmatchSectionItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/unmatch")(pathParams);
