...
import { ChangePasswordServerList } from "../models/operations/changepassword.js";
 ...
 */
export function authenticationChangePassword(
  client: PlexAPICore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ChangePasswordServerList[0], { charEncoding: "percent" })();
