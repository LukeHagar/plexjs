...
import { GetAccountXMLServerList } from "../models/operations/getaccountxml.js";
 ...
 */
export function usersGetAccountXML(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountXMLRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAccountXMLServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/users/account")();
