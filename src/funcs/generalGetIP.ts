...
import { GetIPServerList } from "../models/operations/getip.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetIPServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/ip")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.IPResponse$inboundSchema),
