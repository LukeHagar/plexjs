 ...
 */
export function playbackPlayerSubtitleStream(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlayerSubtitleStreamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/subtitleStream")();
