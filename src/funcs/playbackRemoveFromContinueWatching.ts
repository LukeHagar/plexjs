 ...
 */
export function playbackRemoveFromContinueWatching(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveFromContinueWatchingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/actions/removeFromContinueWatching")();
