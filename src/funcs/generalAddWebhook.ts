...
import { AddWebhookServerList } from "../models/operations/addwebhook.js";
 ...
 */
export function generalAddWebhook(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddWebhookRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(AddWebhookServerList[0], { charEncoding: "percent" })();
