...
import { GetAuthKeysServerList } from "../models/operations/getauthkeys.js";
 ...
 */
export function authenticationGetAuthKeys(
  client: PlexAPICore,
  request: operations.GetAuthKeysRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.AuthKeysResponse,
    | errors.ErrorT
    | PlexAPIError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAuthKeysRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAuthKeysServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.AuthKeysResponse$inboundSchema),
