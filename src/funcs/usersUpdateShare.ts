...
import { UpdateShareServerList } from "../models/operations/updateshare.js";
 ...
 */
export function usersUpdateShare(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateShareRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateShareServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/sharings/{userId}")(pathParams);
