 ...
 */
export function libraryUploadPoster(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UploadPosterRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/posters")(pathParams);
