 ...
 */
export function transcoderTranscodeMusic(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TranscodeMusicRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/music/:/transcode")();
