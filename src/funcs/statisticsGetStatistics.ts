...
export async function statisticsGetStatistics(
    ...
    Result<
        ...
        | errors.GetStatisticsResponseBody
        | errors.GetStatisticsStatisticsResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetStatisticsResponse$inboundSchema, { key: "object" }),
        m$.jsonErr(400, errors.GetStatisticsResponseBody$inboundSchema),
        m$.jsonErr(401, errors.GetStatisticsStatisticsResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
