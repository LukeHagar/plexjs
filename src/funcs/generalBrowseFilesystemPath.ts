 ...
 */
export function generalBrowseFilesystemPath(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BrowseFilesystemPathRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    base64path: encodeSimple("base64path", payload.base64path, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/services/browse/{base64path}")(pathParams);
