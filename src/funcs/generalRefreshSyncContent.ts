 ...
 */
export function generalRefreshSyncContent(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RefreshSyncContentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sync/refreshContent")();
