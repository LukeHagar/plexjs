...
import { ShareServerServerList } from "../models/operations/shareserver.js";
 ...
 */
export function usersShareServer(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ShareServerRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ShareServerServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/shared_servers")();
