...
import { UpdateRestrictedUserServerList } from "../models/operations/updaterestricteduser.js";
 ...
 */
export function usersUpdateRestrictedUser(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRestrictedUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateRestrictedUserServerList[0], {
  ...
  const path = pathToFunc("/home/users/restricted/{userId}")(pathParams);
