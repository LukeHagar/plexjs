 ...
 */
export function libraryGetByContentRating(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetByContentRatingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/byContentRating")(
    pathParams,
  );
