...
export enum GetThumbAcceptEnum {
...
> {
  ...
  const headers = new Headers(compactMap({
    Accept: options?.acceptHeaderOverride
      || "application/octet-stream;q=1, text/html;q=0",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.GetThumbResponse$inboundSchema),
    M.text(301, operations.GetThumbResponse$inboundSchema, {
      ctype: "text/html",
    }),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
