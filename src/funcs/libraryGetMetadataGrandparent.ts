 ...
 */
export function libraryGetMetadataGrandparent(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMetadataGrandparentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/grandparent")(pathParams);
