...
export async function playlistsGetPlaylist(
    ...
    Result<
        ...
        | errors.GetPlaylistPlaylistsResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    >(
        ...
        m$.jsonErr(400, errors.GetPlaylistResponseBody$inboundSchema),
        m$.jsonErr(401, errors.GetPlaylistPlaylistsResponseBody$inboundSchema),
        m$.fail(["4XX", "5XX"])
