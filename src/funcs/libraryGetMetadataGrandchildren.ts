 ...
 */
export function libraryGetMetadataGrandchildren(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMetadataGrandchildrenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{id}/grandchildren")(pathParams);
