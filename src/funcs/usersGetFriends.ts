...
import { GetFriendsServerList } from "../models/operations/getfriends.js";
 ...
 */
export function usersGetFriends(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFriendsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetFriendsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFriendsResponse$inboundSchema),
