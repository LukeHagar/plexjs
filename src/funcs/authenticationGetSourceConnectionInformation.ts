...
export async function authenticationGetSourceConnectionInformation(
    ...
    Result<
        ...
        | models.GetSourceConnectionInformationResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(200, models.GetSourceConnectionInformationResponse$inboundSchema),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetSourceConnectionInformationResponseBody$inboundSchema)
