 ...
 */
export function playbackPlayerSetTextStream(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlayerSetTextStreamRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/setTextStream")();
