 ...
 */
export function libraryGetRecentlyAddedForSection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRecentlyAddedForSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/recentlyAdded")(
    pathParams,
  );
