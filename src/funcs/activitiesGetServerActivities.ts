...
export async function activitiesGetServerActivities(
    ...
    Result<
        models.GetServerActivitiesResponse,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetServerActivitiesResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetServerActivitiesActivitiesResponseBody$inboundSchema)
