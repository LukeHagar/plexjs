...
> {
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.GetServerListResponse$inboundSchema, {
      key: "object",
    }),
    m$.jsonErr(400, errors.GetServerListBadRequest$inboundSchema),
    m$.jsonErr(401, errors.GetServerListUnauthorized$inboundSchema),
    m$.fail(["4XX", "5XX"]),
