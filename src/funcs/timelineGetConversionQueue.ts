 ...
 */
export function timelineGetConversionQueue(
  client: PlexAPICore,
  request: operations.GetConversionQueueRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.MediaContainerWithPlayQueue,
    | errors.ErrorT
    | PlexAPIError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetConversionQueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/1")();
  ...
  const context = {
    ...
    operationID: "getConversionQueue",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.MediaContainerWithPlayQueue$inboundSchema),
