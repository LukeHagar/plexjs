...
import { UpdateHomeUserServerList } from "../models/operations/updatehomeuser.js";
 ...
 */
export function usersUpdateHomeUser(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateHomeUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateHomeUserServerList[0], { charEncoding: "percent" })();
