...
import { GetAccountJSONServerList } from "../models/operations/getaccountjson.js";
 ...
 */
export function usersGetAccountJSON(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountJSONRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAccountJSONServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/users/account.json")();
