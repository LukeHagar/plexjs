...
import { UpdateViewStateSyncServerList } from "../models/operations/updateviewstatesync.js";
 ...
 */
export function usersUpdateViewStateSync(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateViewStateSyncRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateViewStateSyncServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/user/view_state_sync")();
