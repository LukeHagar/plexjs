...
import { GetWatchlistServerList } from "../models/operations/getwatchlist.js";
 ...
 */
export function providerGetWatchlist(
  client: PlexAPICore,
...
> {
  ...
  const path = pathToFunc("/library/sections/watchlist/all")();
