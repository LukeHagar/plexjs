...
import { RemoveShareServerList } from "../models/operations/removeshare.js";
 ...
 */
export function usersRemoveShare(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RemoveShareRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RemoveShareServerList[0], { charEncoding: "percent" })();
