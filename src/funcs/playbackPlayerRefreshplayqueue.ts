 ...
 */
export function playbackPlayerRefreshplayqueue(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlayerRefreshplayqueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/refreshPlayQueue")();
  ...
  const headers = new Headers(compactMap({
    ...
    "X-Plex-Target-Client-Identifier": encodeSimple(
      "X-Plex-Target-Client-Identifier",
      payload["X-Plex-Target-Client-Identifier"],
      { explode: false, charEncoding: "none" },
    ),
