...
import { GetGeoIPServerList } from "../models/operations/getgeoip.js";
 ...
 */
export function generalGetGeoIP(
  client: PlexAPICore,
  request: operations.GetGeoIPRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    shared.GeoIPResponse,
    | errors.ErrorT
    | PlexAPIError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetGeoIPRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetGeoIPServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.GeoIPResponse$inboundSchema),
