 ...
 */
export function transcoderGetHLSSegment(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHLSSegmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/{transcodeType}/:/transcode/universal/session/{sessionId}/{segmentId}.ts",
  )(pathParams);
