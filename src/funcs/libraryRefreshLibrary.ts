 ...
 *
 */
export async function libraryRefreshLibrary(
    client$: PlexAPICore,
    sectionId: number,
    options?: RequestOptions
): Promise<
    Result<
        models.RefreshLibraryResponse,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(200, models.RefreshLibraryResponse$inboundSchema),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.RefreshLibraryResponseBody$inboundSchema)
