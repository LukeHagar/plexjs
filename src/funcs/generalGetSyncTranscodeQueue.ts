 ...
 */
export function generalGetSyncTranscodeQueue(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSyncTranscodeQueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sync/transcodeQueue")();
