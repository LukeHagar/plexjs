 ...
 */
export function playbackPlayerPlayMedia(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerPlayMediaRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/playMedia")();
