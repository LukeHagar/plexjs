 ...
 */
export function generalGetMetadataAgentDetails(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMetadataAgentDetailsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/system/agents/{agentId}")(pathParams);
