...
export async function sessionsGetTranscodeSessions(
    ...
    Result<
        models.GetTranscodeSessionsResponse,
        | models.GetTranscodeSessionsSessionsResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetTranscodeSessionsResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetTranscodeSessionsSessionsResponseBody$inboundSchema)
