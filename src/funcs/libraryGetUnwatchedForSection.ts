 ...
 */
export function libraryGetUnwatchedForSection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetUnwatchedForSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/unwatched")(
    pathParams,
  );
