...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetAllMediaLibraryResponse$inboundSchema, {
      key: "object",
    }),
    M.jsonErr(400, errors.GetAllMediaLibraryBadRequest$inboundSchema),
    M.jsonErr(401, errors.GetAllMediaLibraryUnauthorized$inboundSchema),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
