 ...
 *
 */
export async function librarySearchLibrary(
    client$: PlexAPICore,
    sectionId: number,
    type: models.Type,
    ...
    Result<
        models.SearchLibraryResponse,
        | models.SearchLibraryLibraryResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const path$ = pathToFunc("/library/sections/{sectionId}/search")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.SearchLibraryResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.SearchLibraryLibraryResponseBody$inboundSchema)
