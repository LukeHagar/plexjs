...
export async function statisticsGetResourcesStatistics(
    ...
    Result<
        models.GetResourcesStatisticsResponse,
        | models.GetResourcesStatisticsStatisticsResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, models.GetResourcesStatisticsResponse$inboundSchema, { key: "object" }),
        m$.fail([400, "4XX", "5XX"]),
        m$.jsonErr(401, models.GetResourcesStatisticsStatisticsResponseBody$inboundSchema)
