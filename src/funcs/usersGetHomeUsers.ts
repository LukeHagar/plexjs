...
import { GetHomeUsersServerList } from "../models/operations/gethomeusers.js";
 ...
 */
export function usersGetHomeUsers(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHomeUsersRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetHomeUsersServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/home/users")();
