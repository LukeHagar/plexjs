 ...
 */
export function libraryMatchSectionItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MatchSectionItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/match")(pathParams);
