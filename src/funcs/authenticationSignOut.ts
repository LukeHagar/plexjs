...
import { SignOutServerList } from "../models/operations/signout.js";
 ...
 */
export function authenticationSignOut(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SignOutRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(SignOutServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/users/signout")();
