 ...
 */
export function libraryMoveSection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MoveSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/move")(pathParams);
