 ...
 */
export function libraryGetSectionEpisodes(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSectionEpisodesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/episodes")(pathParams);
