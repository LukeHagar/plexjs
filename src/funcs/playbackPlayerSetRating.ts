 ...
 */
export function playbackPlayerSetRating(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PlayerSetRatingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/setRating")();
