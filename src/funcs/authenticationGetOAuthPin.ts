...
import { GetOAuthPinServerList } from "../models/operations/getoauthpin.js";
 ...
 */
export function authenticationGetOAuthPin(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetOAuthPinRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetOAuthPinServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOAuthPinResponse$inboundSchema),
