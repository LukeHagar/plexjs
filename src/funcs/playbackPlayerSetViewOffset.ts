 ...
 */
export function playbackPlayerSetViewOffset(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PlayerSetViewOffsetRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/player/playback/setViewOffset")();
