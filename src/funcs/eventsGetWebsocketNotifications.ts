 ...
 */
export function eventsGetWebsocketNotifications(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWebsocketNotificationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/:/websockets/notifications")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(101, types$.optional(b64$.zodInbound)),
