...
import { GetWebhooksServerList } from "../models/operations/getwebhooks.js";
 ...
 */
export function generalGetWebhooks(
  client: PlexAPICore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetWebhooksServerList[0], { charEncoding: "percent" })();
