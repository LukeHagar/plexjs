...
export namespace TaskName$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TaskName> = z.nativeEnum(TaskName);
    export const outboundSchema: z.ZodNativeEnum<typeof TaskName> = inboundSchema;
}
