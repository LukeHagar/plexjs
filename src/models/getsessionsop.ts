...
/** @internal */
export const GetSessionsStream$inboundSchema: z.ZodType<GetSessionsStream, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const GetSessionsPart$inboundSchema: z.ZodType<GetSessionsPart, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetSessionsMedia$inboundSchema: z.ZodType<GetSessionsMedia, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetSessionsUser$inboundSchema: z.ZodType<GetSessionsUser, z.ZodTypeDef, unknown> =
    z.object({
        id: z.string().optional(),
...
/** @internal */
export const Player$inboundSchema: z.ZodType<Player, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Player$outboundSchema: z.ZodType<Player$Outbound, z.ZodTypeDef, Player> = z.object({
    address: z.string().optional(),
    machineIdentifier: z.string().optional(),
    model: z.string().optional(),
    platform: z.string().optional(),
