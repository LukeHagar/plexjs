...
export namespace GetSessionHistoryRequest$ {
    export const inboundSchema: z.ZodType<GetSessionHistoryRequest, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetSessionHistoryRequest> =
        z.object({
            sort: z.string().optional(),
            accountId: z.number().int().optional(),
