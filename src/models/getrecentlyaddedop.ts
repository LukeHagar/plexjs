...
/** @internal */
export const Part$inboundSchema: z.ZodType<Part, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Part$outboundSchema: z.ZodType<Part$Outbound, z.ZodTypeDef, Part> = z.object({
    id: z.number().optional(),
    key: z.string().optional(),
    duration: z.number().optional(),
    file: z.string().optional(),
...
/** @internal */
export const GetRecentlyAddedMedia$inboundSchema: z.ZodType<
...
/** @internal */
export type GetRecentlyAddedMedia$Outbound = {
    id?: number | undefined;
    duration?: number | undefined;
    bitrate?: number | undefined;
    width?: number | undefined;
...
/** @internal */
export const GetRecentlyAddedMedia$outboundSchema: z.ZodType<
    GetRecentlyAddedMedia$Outbound,
    z.ZodTypeDef,
    GetRecentlyAddedMedia
> = z
    .object({
...
export namespace GetRecentlyAddedMedia$ {
    /** @deprecated use `GetRecentlyAddedMedia$inboundSchema` instead. */
    export const inboundSchema = GetRecentlyAddedMedia$inboundSchema;
    /** @deprecated use `GetRecentlyAddedMedia$outboundSchema` instead. */
    export const outboundSchema = GetRecentlyAddedMedia$outboundSchema;
    /** @deprecated use `GetRecentlyAddedMedia$Outbound` instead. */
    export type Outbound = GetRecentlyAddedMedia$Outbound;
}

/** @internal */
export const Genre$inboundSchema: z.ZodType<Genre, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Genre$outboundSchema: z.ZodType<Genre$Outbound, z.ZodTypeDef, Genre> = z.object({
    tag: z.string().optional(),
});
...
/** @internal */
export const Director$inboundSchema: z.ZodType<Director, z.ZodTypeDef, unknown> = z.object({
    tag: z.string().optional(),
});
...
/** @internal */
export const Director$outboundSchema: z.ZodType<Director$Outbound, z.ZodTypeDef, Director> =
    z.object({
        tag: z.string().optional(),
    });
...
/** @internal */
export const Writer$inboundSchema: z.ZodType<Writer, z.ZodTypeDef, unknown> = z.object({
    tag: z.string().optional(),
});
...
/** @internal */
export const Writer$outboundSchema: z.ZodType<Writer$Outbound, z.ZodTypeDef, Writer> = z.object({
    tag: z.string().optional(),
});
...
> = z
    .object({
        ...
        mediaTagVersion: z.number().optional(),
        mixedParents: z.boolean().optional(),
        metadata: z.array(z.lazy(() => GetRecentlyAddedMetadata$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            metadata: "Metadata",
