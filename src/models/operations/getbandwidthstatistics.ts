...
export type GetBandwidthStatisticsGlobals = {
  /**
...
> = z.object({
  ...
  timespan: z.int().optional(),
  accountID: z.int().optional(),
  deviceID: z.int().optional(),
  lan: shared.BoolInt$outboundSchema.default(shared.BoolInt.False),
}).transform((v) => {
  return remap$(v, {
