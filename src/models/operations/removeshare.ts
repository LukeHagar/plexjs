...
export const RemoveShareServerList = [
  "https://plex.tv/api/v2",
] as const;

export type RemoveShareGlobals = {
  /**
...
/** @internal */
export type RemoveShareRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const RemoveShareRequest$outboundSchema: z.ZodType<
  RemoveShareRequest$Outbound,
  RemoveShareRequest
> = z.object({
...
export function removeShareRequestToJSON(
  removeShareRequest: RemoveShareRequest,
): string {
  return JSON.stringify(
    RemoveShareRequest$outboundSchema.parse(removeShareRequest),
  );
}
