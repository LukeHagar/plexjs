...
/** @internal */
export const GetTransientTokenType$outboundSchema: z.ZodEnum<
  typeof GetTransientTokenType
> = z.enum(GetTransientTokenType);

/** @internal */
export const GetTransientTokenScope$outboundSchema: z.ZodEnum<
  typeof GetTransientTokenScope
> = z.enum(GetTransientTokenScope);
...
> = z.object({
  MediaContainer: types.optional(
    z.lazy(() => GetTransientTokenMediaContainer$inboundSchema),
  ),
}).transform((v) => {
  return remap$(v, {
