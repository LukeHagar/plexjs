...
export const UpdateShareServerList = [
  "https://plex.tv/api/v2",
] as const;

export type UpdateShareGlobals = {
  /**
...
/** @internal */
export type UpdateShareRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const UpdateShareRequest$outboundSchema: z.ZodType<
  UpdateShareRequest$Outbound,
  UpdateShareRequest
> = z.object({
...
export function updateShareRequestToJSON(
  ...
  return JSON.stringify(
    UpdateShareRequest$outboundSchema.parse(updateShareRequest),
  );
}
