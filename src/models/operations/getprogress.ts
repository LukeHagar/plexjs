...
export type GetProgressGlobals = {
  /**
...
export type GetProgressRequest = {
  /**
   * Indicates the client accepts the indicated media types
   */
  accepts?: shared.Accepts | undefined;
...
/** @internal */
export type GetProgressRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const GetProgressRequest$outboundSchema: z.ZodType<
  GetProgressRequest$Outbound,
  GetProgressRequest
> = z.object({
...
export function getProgressRequestToJSON(
  getProgressRequest: GetProgressRequest,
): string {
  return JSON.stringify(
    GetProgressRequest$outboundSchema.parse(getProgressRequest),
  );
}
