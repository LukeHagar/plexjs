...
/** @internal */
export const ReportState$outboundSchema: z.ZodEnum<typeof ReportState> = z.enum(
  ReportState,
);
...
> = z.object({
  ...
  timeToFirstFrame: z.int().optional(),
  timeStalled: z.int().optional(),
...
/** @internal */
export const ReportResponse$inboundSchema: z.ZodType<ReportResponse, unknown> =
  z.object({
    MediaContainer: types.optional(
      z.lazy(() => ReportMediaContainer$inboundSchema),
    ),
  }).transform((v) => {
    return remap$(v, {
