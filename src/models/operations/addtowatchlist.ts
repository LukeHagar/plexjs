...
export const AddToWatchlistServerList = [
  "https://discover.provider.plex.tv",
] as const;

export type AddToWatchlistGlobals = {
  /**
...
/** @internal */
export type AddToWatchlistRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const AddToWatchlistRequest$outboundSchema: z.ZodType<
  AddToWatchlistRequest$Outbound,
...
export function addToWatchlistRequestToJSON(
  addToWatchlistRequest: AddToWatchlistRequest,
): string {
  return JSON.stringify(
    AddToWatchlistRequest$outboundSchema.parse(addToWatchlistRequest),
  );
}
