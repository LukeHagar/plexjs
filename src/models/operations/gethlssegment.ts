...
export type GetHLSSegmentGlobals = {
  /**
...
export type GetHLSSegmentRequest = {
  /**
   * Indicates the client accepts the indicated media types
   */
  accepts?: shared.Accepts | undefined;
...
/** @internal */
export type GetHLSSegmentRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const GetHLSSegmentRequest$outboundSchema: z.ZodType<
  GetHLSSegmentRequest$Outbound,
...
export function getHLSSegmentRequestToJSON(
  getHLSSegmentRequest: GetHLSSegmentRequest,
): string {
  return JSON.stringify(
    GetHLSSegmentRequest$outboundSchema.parse(getHLSSegmentRequest),
  );
}
