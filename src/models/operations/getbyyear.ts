...
/** @internal */
export type GetByYearRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const GetByYearRequest$outboundSchema: z.ZodType<
  GetByYearRequest$Outbound,
  GetByYearRequest
> = z.object({
...
export function getByYearRequestToJSON(
  getByYearRequest: GetByYearRequest,
): string {
  return JSON.stringify(
    GetByYearRequest$outboundSchema.parse(getByYearRequest),
  );
}
