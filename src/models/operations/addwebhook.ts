...
export const AddWebhookServerList = [
  "https://plex.tv/api/v2",
] as const;

export type AddWebhookGlobals = {
  /**
...
/** @internal */
export type AddWebhookRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const AddWebhookRequest$outboundSchema: z.ZodType<
  AddWebhookRequest$Outbound,
  AddWebhookRequest
> = z.object({
...
export function addWebhookRequestToJSON(
  addWebhookRequest: AddWebhookRequest,
): string {
  return JSON.stringify(
    AddWebhookRequest$outboundSchema.parse(addWebhookRequest),
  );
}
