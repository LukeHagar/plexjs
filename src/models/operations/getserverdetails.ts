...
export const GetServerDetailsServerList = [
  "https://plex.tv/api",
] as const;

export type GetServerDetailsGlobals = {
  /**
...
export type GetServerDetailsRequest = {
  /**
   * Indicates the client accepts the indicated media types
   */
  accepts?: shared.Accepts | undefined;
...
/** @internal */
export type GetServerDetailsRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const GetServerDetailsRequest$outboundSchema: z.ZodType<
  GetServerDetailsRequest$Outbound,
...
export function getServerDetailsRequestToJSON(
  getServerDetailsRequest: GetServerDetailsRequest,
): string {
  return JSON.stringify(
    GetServerDetailsRequest$outboundSchema.parse(getServerDetailsRequest),
  );
}
