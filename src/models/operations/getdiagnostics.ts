...
export type GetDiagnosticsGlobals = {
  /**
...
/** @internal */
export type GetDiagnosticsRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const GetDiagnosticsRequest$outboundSchema: z.ZodType<
  GetDiagnosticsRequest$Outbound,
...
export function getDiagnosticsRequestToJSON(
  getDiagnosticsRequest: GetDiagnosticsRequest,
): string {
  return JSON.stringify(
    GetDiagnosticsRequest$outboundSchema.parse(getDiagnosticsRequest),
  );
}
