...
/** @internal */
export const MakeDecisionLocation$outboundSchema: z.ZodEnum<
  typeof MakeDecisionLocation
> = z.enum(MakeDecisionLocation);

/** @internal */
export const MakeDecisionProtocol$outboundSchema: z.ZodEnum<
  typeof MakeDecisionProtocol
> = z.enum(MakeDecisionProtocol);

/** @internal */
export const MakeDecisionSubtitles$outboundSchema: z.ZodEnum<
  typeof MakeDecisionSubtitles
> = z.enum(MakeDecisionSubtitles);
