...
export type RefreshSectionPostGlobals = {
  /**
...
export type RefreshSectionPostRequest = {
  /**
   * Indicates the client accepts the indicated media types
   */
  accepts?: shared.Accepts | undefined;
...
/** @internal */
export type RefreshSectionPostRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const RefreshSectionPostRequest$outboundSchema: z.ZodType<
  RefreshSectionPostRequest$Outbound,
...
export function refreshSectionPostRequestToJSON(
  refreshSectionPostRequest: RefreshSectionPostRequest,
): string {
  return JSON.stringify(
    RefreshSectionPostRequest$outboundSchema.parse(refreshSectionPostRequest),
  );
}
