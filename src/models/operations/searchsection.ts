...
export type SearchSectionGlobals = {
  /**
...
/** @internal */
export type SearchSectionRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const SearchSectionRequest$outboundSchema: z.ZodType<
  SearchSectionRequest$Outbound,
...
export function searchSectionRequestToJSON(
  searchSectionRequest: SearchSectionRequest,
): string {
  return JSON.stringify(
    SearchSectionRequest$outboundSchema.parse(searchSectionRequest),
  );
}
