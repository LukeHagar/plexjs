...
export type OptimizeSectionGlobals = {
  /**
...
/** @internal */
export type OptimizeSectionRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const OptimizeSectionRequest$outboundSchema: z.ZodType<
  OptimizeSectionRequest$Outbound,
...
export function optimizeSectionRequestToJSON(
  optimizeSectionRequest: OptimizeSectionRequest,
): string {
  return JSON.stringify(
    OptimizeSectionRequest$outboundSchema.parse(optimizeSectionRequest),
  );
}
