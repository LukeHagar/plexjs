...
export type MoveSectionGlobals = {
  /**
...
/** @internal */
export type MoveSectionRequest$Outbound = {
  accepts: string;
...
/** @internal */
export const MoveSectionRequest$outboundSchema: z.ZodType<
  MoveSectionRequest$Outbound,
  MoveSectionRequest
> = z.object({
...
export function moveSectionRequestToJSON(
  moveSectionRequest: MoveSectionRequest,
): string {
  return JSON.stringify(
    MoveSectionRequest$outboundSchema.parse(moveSectionRequest),
  );
}
