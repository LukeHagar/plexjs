...
export type MediaGrabOperationStatusOpen = OpenEnum<
...
export type MediaGrabOperation = {
  ...
  status?: MediaGrabOperationStatusOpen | undefined;
};

/** @internal */
export const MediaGrabOperationStatus$inboundSchema: z.ZodType<
  MediaGrabOperationStatusOpen,
  unknown
> = openEnums.inboundSchema(MediaGrabOperationStatus);
...
export const MediaGrabOperation$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  currentSize: types.optional(types.number()),
  grabberIdentifier: types.optional(types.string()),
  grabberProtocol: types.optional(types.string()),
  id: types.optional(types.string()),
  key: types.optional(types.string()),
  mediaIndex: types.optional(types.number()),
  mediaSubscriptionID: types.optional(types.number()),
  Metadata: types.optional(Metadata$inboundSchema),
  percent: types.optional(types.number()),
  provider: types.optional(types.string()),
  status: types.optional(MediaGrabOperationStatus$inboundSchema),
}).transform((v) => {
  return remap$(v, {
    "Metadata": "metadata",
  });
