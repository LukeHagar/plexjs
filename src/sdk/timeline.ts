...
import { timelineGetConversionQueue } from "../funcs/timelineGetConversionQueue.js";
...
export class Timeline extends ClientSDK {
   ...
   */
  async getConversionQueue(
    request: operations.GetConversionQueueRequest,
    options?: RequestOptions,
  ): Promise<shared.MediaContainerWithPlayQueue> {
    return unwrapAsync(timelineGetConversionQueue(
      this,
      request,
      options,
    ));
