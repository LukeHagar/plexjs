...
export class Search extends ClientSDK {
  ...
  ): Promise<operations.SearchHubsResponse> {
    return unwrapAsync(searchSearchHubs(
      this,
      request,
      options,
    ));
   ...
   */
  async voiceSearchHubs(
    request: operations.VoiceSearchHubsRequest,
    options?: RequestOptions,
  ): Promise<operations.VoiceSearchHubsResponse> {
    return unwrapAsync(searchVoiceSearchHubs(
      this,
      request,
      options,
    ));
