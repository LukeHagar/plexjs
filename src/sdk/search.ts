...
import { searchGetSearchResults } from "../funcs/searchGetSearchResults.js";
...
export class Search extends ClientSDK {
  ...
  async performSearch(
    ...
    return unwrapAsync(searchPerformSearch(
      this,
      query,
      sectionId,
      limit,
  ...
  async performVoiceSearch(
    ...
    return unwrapAsync(searchPerformVoiceSearch(
      this,
      query,
      sectionId,
      limit,
  ...
  async getSearchResults(
    ...
    return unwrapAsync(searchGetSearchResults(
      this,
      query,
      options,
    ));
