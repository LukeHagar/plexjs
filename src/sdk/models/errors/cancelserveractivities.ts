 ...
 * Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
 */
export class CancelServerActivitiesUnauthorized extends PlexAPIError {
  errors?: Array<CancelServerActivitiesActivitiesErrors> | undefined;
  ...
  constructor(
    err: CancelServerActivitiesUnauthorizedData,
 ...
 * Bad Request - A parameter was not specified, or was specified incorrectly.
 */
export class CancelServerActivitiesBadRequest extends PlexAPIError {
  errors?: Array<CancelServerActivitiesErrors> | undefined;
  ...
  constructor(
    err: CancelServerActivitiesBadRequestData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
