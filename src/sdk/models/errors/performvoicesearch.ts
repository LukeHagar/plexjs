 ...
 * Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
 */
export class PerformVoiceSearchUnauthorized extends PlexAPIError {
  errors?: Array<PerformVoiceSearchSearchErrors> | undefined;
  ...
  constructor(
    err: PerformVoiceSearchUnauthorizedData,
 ...
 * Bad Request - A parameter was not specified, or was specified incorrectly.
 */
export class PerformVoiceSearchBadRequest extends PlexAPIError {
  errors?: Array<PerformVoiceSearchErrors> | undefined;
  ...
  constructor(
    err: PerformVoiceSearchBadRequestData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
