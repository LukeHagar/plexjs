 ...
 * Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
 */
export class GetCountriesLibraryUnauthorized extends PlexAPIError {
  errors?: Array<GetCountriesLibraryLibraryErrors> | undefined;
  ...
  constructor(
    err: GetCountriesLibraryUnauthorizedData,
 ...
 * Bad Request - A parameter was not specified, or was specified incorrectly.
 */
export class GetCountriesLibraryBadRequest extends PlexAPIError {
  errors?: Array<GetCountriesLibraryErrors> | undefined;
  ...
  constructor(
    err: GetCountriesLibraryBadRequestData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
