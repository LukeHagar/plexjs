 ...
 * Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
 */
export class MarkUnplayedUnauthorized extends PlexAPIError {
  errors?: Array<MarkUnplayedMediaErrors> | undefined;
  ...
  constructor(
    err: MarkUnplayedUnauthorizedData,
 ...
 * Bad Request - A parameter was not specified, or was specified incorrectly.
 */
export class MarkUnplayedBadRequest extends PlexAPIError {
  errors?: Array<MarkUnplayedErrors> | undefined;
  ...
  constructor(
    err: MarkUnplayedBadRequestData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
