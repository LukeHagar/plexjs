 ...
 * Unauthorized - Returned if the X-Plex-Token is missing from the header or query.
 */
export class AddPlaylistContentsUnauthorized extends PlexAPIError {
  errors?: Array<AddPlaylistContentsPlaylistsErrors> | undefined;
  ...
  constructor(
    err: AddPlaylistContentsUnauthorizedData,
 ...
 * Bad Request - A parameter was not specified, or was specified incorrectly.
 */
export class AddPlaylistContentsBadRequest extends PlexAPIError {
  errors?: Array<AddPlaylistContentsErrors> | undefined;
