...
/** @internal */
export const Pivot$inboundSchema: z.ZodType<Pivot, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Pivot$outboundSchema: z.ZodType<Pivot$Outbound, z.ZodTypeDef, Pivot> = z.object({
    id: z.string().optional(),
    key: z.string().optional(),
    type: z.string().optional(),
    title: z.string().optional(),
...
/** @internal */
export const Feature$inboundSchema: z.ZodType<Feature, z.ZodTypeDef, unknown> = z
    .object({
        key: z.string().optional(),
        type: z.string().optional(),
        Directory: z.array(z.lazy(() => GetMediaProvidersDirectory$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            Directory: "directory",
...
/** @internal */
export const Feature$outboundSchema: z.ZodType<Feature$Outbound, z.ZodTypeDef, Feature> = z
    .object({
        key: z.string().optional(),
        type: z.string().optional(),
        directory: z.array(z.lazy(() => GetMediaProvidersDirectory$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            directory: "Directory",
...
/** @internal */
export const MediaProvider$inboundSchema: z.ZodType<MediaProvider, z.ZodTypeDef, unknown> = z
    .object({
...
> = z
    .object({
        MediaContainer: z.lazy(() => GetMediaProvidersMediaContainer$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        mediaContainer: z.lazy(() => GetMediaProvidersMediaContainer$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            mediaContainer: "MediaContainer",
