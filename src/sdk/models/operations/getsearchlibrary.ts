...
> = z
    .object({
        ...
        Metadata: z.array(z.lazy(() => GetSearchLibraryMetadata$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            Metadata: "metadata",
...
> = z
    .object({
        ...
        viewGroup: z.string().optional(),
        viewMode: z.number().int().optional(),
        metadata: z.array(z.lazy(() => GetSearchLibraryMetadata$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            metadata: "Metadata",
...
> = z
    .object({
        MediaContainer: z.lazy(() => GetSearchLibraryMediaContainer$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        mediaContainer: z.lazy(() => GetSearchLibraryMediaContainer$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
            mediaContainer: "MediaContainer",
