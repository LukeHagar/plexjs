...
> = z.object({
  ...
  Country: z.array(z.lazy(() => GetLibraryHubsCountry$inboundSchema))
    .optional(),
  Director: z.array(z.lazy(() => GetLibraryHubsDirector$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  country: z.array(z.lazy(() => GetLibraryHubsCountry$outboundSchema))
    .optional(),
  director: z.array(z.lazy(() => GetLibraryHubsDirector$outboundSchema))
    .optional(),
...
> = z.object({
  ...
  Metadata: z.array(z.lazy(() => GetLibraryHubsMetadata$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  style: z.string().optional(),
  hubKey: z.string().optional(),
  metadata: z.array(z.lazy(() => GetLibraryHubsMetadata$outboundSchema))
    .optional(),
  promoted: z.boolean().optional(),
  random: z.boolean().optional(),
}).transform((v) => {
...
export const GetLibraryHubsResponseBody$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  MediaContainer: z.lazy(() => GetLibraryHubsMediaContainer$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export const GetLibraryHubsResponseBody$outboundSchema: z.ZodType<
  ...
  GetLibraryHubsResponseBody
> = z.object({
  mediaContainer: z.lazy(() => GetLibraryHubsMediaContainer$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    mediaContainer: "MediaContainer",
