...
> = z.object({
  ...
  Metadata: z.array(z.lazy(() => AddPlaylistContentsMetadata$inboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
    "Metadata": "metadata",
...
> = z.object({
  ...
  leafCountAdded: z.number().int().optional(),
  leafCountRequested: z.number().int().optional(),
  metadata: z.array(z.lazy(() => AddPlaylistContentsMetadata$outboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
    metadata: "Metadata",
...
export namespace AddPlaylistContentsMediaContainer$ {
  ...
  export const outboundSchema =
    AddPlaylistContentsMediaContainer$outboundSchema;
...
export const AddPlaylistContentsResponseBody$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  MediaContainer: z.lazy(() => AddPlaylistContentsMediaContainer$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export const AddPlaylistContentsResponseBody$outboundSchema: z.ZodType<
  ...
  AddPlaylistContentsResponseBody
> = z.object({
  mediaContainer: z.lazy(() => AddPlaylistContentsMediaContainer$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    mediaContainer: "MediaContainer",
...
> = z.object({
  ...
  object: z.lazy(() => AddPlaylistContentsResponseBody$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  object: z.lazy(() => AddPlaylistContentsResponseBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    contentType: "ContentType",
