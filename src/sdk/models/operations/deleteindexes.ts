...
export type DeleteIndexesGlobals = {
  /**
...
export type DeleteIndexesRequest = {
  /**
   * Indicates the client accepts the indicated media types
   */
  accepts?: shared.Accepts | undefined;
...
export type DeleteIndexesResponse = {
  /**
...
/** @internal */
export const DeleteIndexesRequest$outboundSchema: z.ZodType<
  DeleteIndexesRequest$Outbound,
  z.ZodTypeDef,
  DeleteIndexesRequest
> = z.object({
  accepts: shared.Accepts$outboundSchema.default(shared.Accepts.ApplicationXml),
...
export function deleteIndexesRequestToJSON(
  ...
  return JSON.stringify(
    DeleteIndexesRequest$outboundSchema.parse(deleteIndexesRequest),
  );
}
...
export function deleteIndexesResponseFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => DeleteIndexesResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeleteIndexesResponse' from JSON`,
  );
}
