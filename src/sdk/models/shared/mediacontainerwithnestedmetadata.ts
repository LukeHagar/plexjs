...
> = collectExtraKeys$(
  z.object({
    ...
    MetadataItem: z.array(Items$inboundSchema).optional(),
  }).catchall(z.any()),
...
/** @internal */
export type MetadataItem$Outbound = {
  title?: any | undefined;
  type?: any | undefined;
  absoluteIndex?: number | undefined;
  addedAt?: number | undefined;
  ...
  year?: number | undefined;
  MetadataItem?: Array<Items$Outbound> | undefined;
  [additionalProperties: string]: unknown;
};

/** @internal */
export const MetadataItem$outboundSchema: z.ZodType<
  MetadataItem$Outbound,
  z.ZodTypeDef,
  MetadataItem
> = z.object({
  title: z.any().optional(),
  ...
  year: z.number().int().optional(),
  metadataItem: z.array(Items$outboundSchema).optional(),
...
export namespace MetadataItem$ {
  /** @deprecated use `MetadataItem$inboundSchema` instead. */
  export const inboundSchema = MetadataItem$inboundSchema;
  /** @deprecated use `MetadataItem$outboundSchema` instead. */
  export const outboundSchema = MetadataItem$outboundSchema;
  /** @deprecated use `MetadataItem$Outbound` instead. */
  export type Outbound = MetadataItem$Outbound;
}

export function metadataItemToJSON(metadataItem: MetadataItem): string {
  return JSON.stringify(MetadataItem$outboundSchema.parse(metadataItem));
}
...
export const MediaContainerWithNestedMetadataMediaContainer$inboundSchema:
  ...
  > = z.object({
    ...
    MetadataItem: z.array(z.lazy(() => MetadataItem$inboundSchema)).optional(),
  }).transform((v) => {
    return remap$(v, {
      "MetadataItem": "metadataItem",
    });
...
/** @internal */
export type MediaContainerWithNestedMetadataMediaContainer$Outbound = {
  identifier?: string | undefined;
  offset?: number | undefined;
  size?: number | undefined;
  totalSize?: number | undefined;
  MetadataItem?: Array<MetadataItem$Outbound> | undefined;
};

/** @internal */
export const MediaContainerWithNestedMetadataMediaContainer$outboundSchema:
  z.ZodType<
    MediaContainerWithNestedMetadataMediaContainer$Outbound,
    z.ZodTypeDef,
    MediaContainerWithNestedMetadataMediaContainer
  > = z.object({
    identifier: z.string().optional(),
    ...
    size: z.number().int().optional(),
    totalSize: z.number().int().optional(),
    metadataItem: z.array(z.lazy(() => MetadataItem$outboundSchema)).optional(),
  }).transform((v) => {
    return remap$(v, {
      metadataItem: "MetadataItem",
    });
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace MediaContainerWithNestedMetadataMediaContainer$ {
  /** @deprecated use `MediaContainerWithNestedMetadataMediaContainer$inboundSchema` instead. */
  export const inboundSchema =
    MediaContainerWithNestedMetadataMediaContainer$inboundSchema;
  /** @deprecated use `MediaContainerWithNestedMetadataMediaContainer$outboundSchema` instead. */
  export const outboundSchema =
    MediaContainerWithNestedMetadataMediaContainer$outboundSchema;
  /** @deprecated use `MediaContainerWithNestedMetadataMediaContainer$Outbound` instead. */
  export type Outbound =
    MediaContainerWithNestedMetadataMediaContainer$Outbound;
}

export function mediaContainerWithNestedMetadataMediaContainerToJSON(
  mediaContainerWithNestedMetadataMediaContainer:
    MediaContainerWithNestedMetadataMediaContainer,
): string {
  return JSON.stringify(
    MediaContainerWithNestedMetadataMediaContainer$outboundSchema.parse(
      mediaContainerWithNestedMetadataMediaContainer,
    ),
  );
}
...
/** @internal */
export type MediaContainerWithNestedMetadata$Outbound = {
  MediaContainer?:
    | MediaContainerWithNestedMetadataMediaContainer$Outbound
    | undefined;
};
...
/** @internal */
export const MediaContainerWithNestedMetadata$outboundSchema: z.ZodType<
  MediaContainerWithNestedMetadata$Outbound,
  z.ZodTypeDef,
  MediaContainerWithNestedMetadata
> = z.object({
  mediaContainer: z.lazy(() =>
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace MediaContainerWithNestedMetadata$ {
  /** @deprecated use `MediaContainerWithNestedMetadata$inboundSchema` instead. */
  export const inboundSchema = MediaContainerWithNestedMetadata$inboundSchema;
  /** @deprecated use `MediaContainerWithNestedMetadata$outboundSchema` instead. */
  export const outboundSchema = MediaContainerWithNestedMetadata$outboundSchema;
  /** @deprecated use `MediaContainerWithNestedMetadata$Outbound` instead. */
  export type Outbound = MediaContainerWithNestedMetadata$Outbound;
}

export function mediaContainerWithNestedMetadataToJSON(
  mediaContainerWithNestedMetadata: MediaContainerWithNestedMetadata,
): string {
  return JSON.stringify(
    MediaContainerWithNestedMetadata$outboundSchema.parse(
      mediaContainerWithNestedMetadata,
    ),
  );
}
