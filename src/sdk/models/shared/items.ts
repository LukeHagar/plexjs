...
/** @internal */
export const Items$inboundSchema: z.ZodType<Items, z.ZodTypeDef, unknown> =
  collectExtraKeys$(
    z.object({
      ...
      MetadataItem: z.array(z.lazy(() => Items$inboundSchema)).optional(),
    }).catchall(z.any()),
...
> = z.object({
  ...
  year: z.number().int().optional(),
  metadataItem: z.array(z.lazy(() => Items$outboundSchema)).optional(),
