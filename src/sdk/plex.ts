...
import { GetTokenOpServerList } from "../models/gettokenop.js";
...
export class Plex extends ClientSDK {
    ...
    async getPin(
        ...
        const baseURL$ =
            options?.serverURL ||
            this.templateURLComponent(GetPinOpServerList[0], { charEncoding: "percent" })();
    ...
    async getToken(
        ...
        const baseURL$ =
            options?.serverURL ||
            this.templateURLComponent(GetTokenOpServerList[0], { charEncoding: "percent" })();
