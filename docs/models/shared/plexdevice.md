...
```typescript
import { PlexDevice, PlexDeviceProtocol } from "@lukehagar/plexjs/models/shared";
...
| `connections`                                                                                 | [shared.Connection](../../models/shared/connection.md)[]                                      | :heavy_check_mark:                                                                            | N/A                                                                                           |                                                                                               |