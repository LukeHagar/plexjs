...
```typescript
import { DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer } from "@parke.dev/plexjs/models/shared";

let value: DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer = {
