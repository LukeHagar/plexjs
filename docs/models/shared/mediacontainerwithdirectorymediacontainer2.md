# MediaContainerWithDirectoryMediaContainer2
...
```typescript
import { MediaContainerWithDirectoryMediaContainer2 } from "@parke.dev/plexjs/models/shared";

let value: MediaContainerWithDirectoryMediaContainer2 = {
...
| `directory`                                                                                                                             | Record<string, *any*>[]                                                                                                                 | :heavy_minus_sign:                                                                                                                      | N/A                                                                                                                                     |