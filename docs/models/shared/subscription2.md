...
```typescript
import { Subscription2, SubscriptionStatus2 } from "@lukehagar/plexjs/models/shared";
...
| `status`                                                                 | [shared.SubscriptionStatus2](../../models/shared/subscriptionstatus2.md) | :heavy_minus_sign:                                                       | String representation of subscriptionActive                              | Inactive                                                                 |
