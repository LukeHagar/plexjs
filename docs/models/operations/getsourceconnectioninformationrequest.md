...
```typescript
import { GetSourceConnectionInformationRequest } from "@lukehagar/plexjs/models/operations";
...
| `source`                                                       | *string*                                                       | :heavy_check_mark:                                             | The source identifier with an included prefix.                 |                                                                |
| `refresh`                                                      | [shared.BoolInt](../../models/shared/boolint.md)               | :heavy_minus_sign:                                             | Force refresh                                                  | 1                                                              |