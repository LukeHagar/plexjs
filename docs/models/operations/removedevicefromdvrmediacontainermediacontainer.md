...
```typescript
import { RemoveDeviceFromDVRMediaContainerMediaContainer } from "@parke.dev/plexjs/models/operations";

let value: RemoveDeviceFromDVRMediaContainerMediaContainer = {
