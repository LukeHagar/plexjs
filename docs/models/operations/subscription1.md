...
```typescript
import { Subscription1, SubscriptionStatus1 } from "@lukehagar/plexjs/models/operations";
...
| `status`                                                                         | [operations.SubscriptionStatus1](../../models/operations/subscriptionstatus1.md) | :heavy_minus_sign:                                                               | String representation of subscriptionActive                                      | Inactive                                                                         |
