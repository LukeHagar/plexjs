...
```typescript
import { GetStreamLevelsMediaContainer } from "@parke.dev/plexjs/models/operations";

let value: GetStreamLevelsMediaContainer = {
...
| `totalSamples`                                                                                                                          | *string*                                                                                                                                | :heavy_minus_sign:                                                                                                                      | The total number of samples (as a string)                                                                                               |