...
```typescript
import { OptimizeDatabaseRequest } from "@lukehagar/plexjs/models/operations";
...
| `async`                                                        | [shared.BoolInt](../../models/shared/boolint.md)               | :heavy_minus_sign:                                             | If set, don't wait for completion but return an activity       | 1                                                              |