...
| `guid`                                                         | *string*                                                       | :heavy_minus_sign:                                             | The guid of the item for which to get the template             | plex://episode/5fc70265c40548002d539d23                        |
| `mediaType`                                                    | *string*                                                       | :heavy_minus_sign:                                             | Subscription type.                                             |                                                                |
| `targetLibrarySectionID`                                       | *number*                                                       | :heavy_minus_sign:                                             | Target library section ID.                                     |                                                                |