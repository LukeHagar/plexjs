...
```typescript
import { CreateTransientTokenMediaContainer } from "@parke.dev/plexjs/models/operations";

let value: CreateTransientTokenMediaContainer = {
...
| `token`                                                                                                                                 | *string*                                                                                                                                | :heavy_minus_sign:                                                                                                                      | The transient token                                                                                                                     |