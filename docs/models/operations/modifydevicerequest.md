...
```typescript
import { ModifyDeviceRequest } from "@lukehagar/plexjs/models/operations";
...
| `enabled`                                                      | [shared.BoolInt](../../models/shared/boolint.md)               | :heavy_minus_sign:                                             | Whether to enable the device                                   | 1                                                              |