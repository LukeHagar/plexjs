...
```typescript
import { GetRandomArtworkRequest } from "@lukehagar/plexjs/sdk/models/operations";
...
| `sections`                                                     | *number*[]                                                     | :heavy_minus_sign:                                             | The sections for which to fetch artwork.                       | [<br/>5,<br/>6<br/>]                                           |