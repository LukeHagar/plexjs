...
```typescript
import { ListLineupsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: ListLineupsRequest = {
  country: "Reunion",
  epgId: "<id>",
  region: "<value>",
};
...
| `region`                                                       | *string*                                                       | :heavy_check_mark:                                             | The region for the lineup                                      |                                                                |