...
```typescript
import { GetRelatedItemsResponseBody } from "@lukehagar/plexjs/sdk/models/operations";

let value: GetRelatedItemsResponseBody = {
  mediaContainer: {
    hub: [
      {
        type: "track",
...
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `mediaContainer`                                                                                            | [operations.GetRelatedItemsMediaContainer](../../../sdk/models/operations/getrelateditemsmediacontainer.md) | :heavy_minus_sign:                                                                                          | N/A                                                                                                         |