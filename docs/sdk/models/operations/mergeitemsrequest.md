...
```typescript
import { MergeItemsRequest } from "@lukehagar/plexjs/sdk/models/operations";
...
| `idsPathParameter`                                             | *string*                                                       | :heavy_check_mark:                                             | N/A                                                            |                                                                |
| `idsQueryParameter`                                            | *string*[]                                                     | :heavy_minus_sign:                                             | N/A                                                            |                                                                |