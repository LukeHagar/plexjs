...
```typescript
import { GetCountriesLineupsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: GetCountriesLineupsRequest = {
  country: "Eritrea",
  epgId: "<id>",
};
```
...
| `country`                                                      | *string*                                                       | :heavy_check_mark:                                             | 3 letter country code                                          |                                                                |
| `epgId`                                                        | *string*                                                       | :heavy_check_mark:                                             | The `providerIdentifier` of the provider                       |                                                                |
| `postalCode`                                                   | *string*                                                       | :heavy_minus_sign:                                             | The postal code for the lineups to fetch                       |                                                                |