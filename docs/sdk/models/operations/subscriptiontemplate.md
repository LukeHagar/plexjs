...
```typescript
import { SubscriptionTemplate } from "@lukehagar/plexjs/sdk/models/operations";
...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `mediaSubscription`                                                                   | [operations.MediaSubscription](../../../sdk/models/operations/mediasubscription.md)[] | :heavy_minus_sign:                                                                    | N/A                                                                                   |