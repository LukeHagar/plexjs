...
```typescript
import { ListHubsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: ListHubsRequest = {
  sectionId: 893324,
};
```
...
| `metadataItemId`                                               | *number*                                                       | :heavy_minus_sign:                                             | Restrict hubs to ones relevant to the provided metadata item   |                                                                |