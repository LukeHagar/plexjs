...
```typescript
import { GetHubItemsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: GetHubItemsRequest = {
  identifier: [],
};
```
...
| `identifier`                                                   | *string*[]                                                     | :heavy_check_mark:                                             | If provided, limit to only specified hubs                      |                                                                |