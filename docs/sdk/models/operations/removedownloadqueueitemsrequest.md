...
```typescript
import { RemoveDownloadQueueItemsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: RemoveDownloadQueueItemsRequest = {
  queueId: 666393,
  itemId: [
    32,
    345,
...
| `itemId`                                                       | *number*[]                                                     | :heavy_check_mark:                                             | The item id                                                    | [<br/>32,<br/>345,<br/>23<br/>]                                |