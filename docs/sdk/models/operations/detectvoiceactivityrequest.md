...
```typescript
import { DetectVoiceActivityRequest } from "@lukehagar/plexjs/sdk/models/operations";
...
| `manual`                                                       | [shared.BoolInt](../../../sdk/models/shared/boolint.md)        | :heavy_minus_sign:                                             | Indicate whether detection is manually run                     | 1                                                              |