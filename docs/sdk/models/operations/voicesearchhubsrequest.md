...
```typescript
import { VoiceSearchHubsRequest } from "@lukehagar/plexjs/sdk/models/operations";

let value: VoiceSearchHubsRequest = {
  query: "<value>",
};
```
...
| `limit`                                                        | *number*                                                       | :heavy_minus_sign:                                             | The number of items to return per hub.  3 if not specified     |                                                                |