...
```typescript
import { OptimizeDatabaseRequest } from "@lukehagar/plexjs/sdk/models/operations";
...
| `async`                                                        | [shared.BoolInt](../../../sdk/models/shared/boolint.md)        | :heavy_minus_sign:                                             | If set, don't wait for completion but return an activity       | 1                                                              |