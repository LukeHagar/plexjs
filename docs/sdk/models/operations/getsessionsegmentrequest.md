...
```typescript
import { GetSessionSegmentRequest } from "@lukehagar/plexjs/sdk/models/operations";
...
| `sessionId`                                                    | *string*                                                       | :heavy_check_mark:                                             | The session id                                                 |                                                                |
| `consumerId`                                                   | *string*                                                       | :heavy_check_mark:                                             | The consumer id                                                |                                                                |
| `segmentId`                                                    | *string*                                                       | :heavy_check_mark:                                             | The segment id                                                 |                                                                |