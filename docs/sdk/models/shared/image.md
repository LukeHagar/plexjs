...
```typescript
import { Image } from "@lukehagar/plexjs/sdk/models/shared";
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ |
| `type`                                                             | [shared.ImageType](../../../sdk/models/shared/imagetype.md)        | :heavy_minus_sign:                                                 | Describes both the purpose and intended presentation of the image. |
