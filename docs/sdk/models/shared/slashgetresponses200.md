...
```typescript
import { SlashGetResponses200 } from "@lukehagar/plexjs/sdk/models/shared";
...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `mediaContainer`                                                                                              | [shared.SlashGetResponses200MediaContainer](../../../sdk/models/shared/slashgetresponses200mediacontainer.md) | :heavy_minus_sign:                                                                                            | N/A                                                                                                           |